...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/07 18:29:21 by hasalam           #+#    #+#             */
/*   Updated: 2023/05/20 03:56:17 by hasalam          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	burnship_helper1(t_fract *burn);
int		mscrool_hook(int mousecode, int x, int y, t_fract *data);
